...
import datetime
import time
from keyword_rank.DBUtility import update_record
...
def search_product_page(search_keywords, item_title, country_code, asin,driver):
...
def search_product_page_by_list(search_keywords, item_title, country_code, asin, proxy):
...
#         print keywords
        print search_product_page(keywords, item_title, country_code, asin,driver)
        time.sleep(20)
